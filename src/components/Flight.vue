<template>
  <div class="container">
    ...
    <h3 class="p-3 text-center">Total Flights</h3>
    ...
    <div class="card card-container">
      ...
      <Form @submit="handleAddRoutes" :validation-schema="schema">
          <div class="form-group">
            ...
            <Field name="flightNo" type="text" class="form-control" />
            <ErrorMessage name="flightNo" class="error-feedback" />
          </div>
          <div class="form-group">
            <label for="route">Route Id</label>
            <Field name="route" type="number" class="form-control" />
            <ErrorMessage name="route" class="error-feedback" />
          </div>
